...
return [
    ...
    */
    ...
    'firebase' => [
        'api_key' => 'AIzaSyC3P-W7fP_0a2cSrnqj5bB75V-7gYGSWKE', // Only used for JS integration
        'auth_domain' => 'jastan-laravel.firebaseapp.com', // Only used for JS integration
        'database_url' => 'https://jastan-laravel.firebaseio.com',
        'secret' => 'secret',
        'storage_bucket' => 'jastan-laravel.appspot.com', // Only used for JS integration
        'projectId' => "jastan-laravel",
        'messagingSenderId' => "439934956006"
    ],
];
