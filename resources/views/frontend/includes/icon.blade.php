        ...
        <link rel="manifest" href="{{route('frontend.index')}}/img/fav/manifest.json">
        <meta name="msapplication-TileColor" content="#ffffff">
        <meta name="msapplication-TileImage" content="/ms-icon-144x144.png' ) }}">
        <meta name="theme-color" content="#ffffff">
        <link rel="shortcut icon" href="{{ asset('img/fav/favicon.ico' ) }}" type="image/x-icon">
        <link rel="icon" href="{{ asset('img/fav/favicon.ico' ) }}" type="image/x-icon">