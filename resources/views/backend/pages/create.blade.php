    ...
    {{ Form::open(['route' => 'admin.pages.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-permission']) }}
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('description_en', trans('validation.attributes.backend.pages.descriptionen'), ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::textarea('description_en', null,['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.pages.descriptionen')]) }}
                    </div><!--col-lg-3-->
                </div><!--form control-->
                <div class="form-group">
