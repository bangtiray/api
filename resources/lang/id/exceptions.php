...
return [
	...
	"finances" => [
	"already_exists" => "That Finance already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Finance. Please try again.",
	"delete_error" => "There was a problem deleting this Finance. Please try again.",
	"not_found" => "That Finance does not exist.",
	"update_error" => "There was a problem updating this Finance. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://localhost:8000/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
